...
namespace GTA5_Empty_Session_Maker
{
    ...
    internal enum PROCESS : int
    {
        ...
        ALL_ACCESS = CREATE_PROCESS | CREATE_THREAD | DUP_HANDLE | QUERY_INFORMATION | QUERY_LIMITED_INFORMATION | SET_INFORMATION | SET_QUOTA | SUSPEND_RESUME | TERMINATE | VM_OPERATION | VM_READ | VM_WRITE | SYNCHRONIZE
    }
    ...
    internal enum THREAD : int
    {
        ...
        ALL_ACCESS = SYNCHRONIZE | DIRECT_IMPERSONATION | GET_CONTEXT | IMPERSONATE | QUERY_INFORMATION | QUERY_LIMITED_INFORMATION | SET_CONTEXT | SET_INFORMATION | SET_LIMITED_INFORMATION | SET_THREAD_TOKEN | SUSPEND_RESUME | TERMINATE
    }
